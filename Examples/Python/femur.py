    ...
    # Else groom the segmentations and get distance transforms for optimization
        ...
        if args.groom_images and image_files:
            ...
            for seg, image, name in zip(seg_list, image_list, names):
                ...
                seg.clip(
                    [
                        cutting_plane_points[0],
                        cutting_plane_points[1],
                        cutting_plane_points[2],
                    ],
                    [
                        cutting_plane_points[3],
                        cutting_plane_points[4],
                        cutting_plane_points[5],
                    ],
                    [
                        cutting_plane_points[6],
                        cutting_plane_points[7],
                        cutting_plane_points[8],
                    ],
                    0.0,
                )
