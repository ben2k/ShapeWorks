...
def get_parameter_text(parameterKey, parameterValue, domains_per_shape):
    ...
    assert len(parameterValue) == domains_per_shape, (
        str(parameterKey)
...
def create_SWRun_xml(xmlfilename, inDataFiles, parameterDictionary, outDir):
    ...
    attribute_scales.text = get_attribute_scales_text(
        parameterDictionary["use_normals"],
        parameterDictionary["normal_weight"],
        parameterDictionary["domains_per_shape"],
    )
    ...
    if (
        "cutting_plane_counts" in parameterDictionary
        and "cutting_planes" in parameterDictionary
    ):
...
def create_SWRun_fixed_domains(
    xmlfilename,
    inDataFiles,
    parameterDictionary,
    outDir,
