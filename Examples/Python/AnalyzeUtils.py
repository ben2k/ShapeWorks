...
def create_analyze_xml(
    xmlfilename, dtFiles, localPointFiles, worldPointFiles, domains_per_shape=1
):
...
def launchShapeWorksStudio(
    parentDir, dtFiles, localPointFiles, worldPointFiles, domains_per_shape=1
):
    xmlfilename = parentDir + "/analyze.xml"
    create_analyze_xml(
        xmlfilename, dtFiles, localPointFiles, worldPointFiles, domains_per_shape
    )
