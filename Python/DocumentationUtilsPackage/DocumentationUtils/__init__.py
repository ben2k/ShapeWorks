...
def generateShapeWorksCommandDocumentation(
    mdFilename="../../docs/tools/ShapeWorksCommands.md", add_toc=False
):
    ...
    if add_toc:
        intro_marker = mdFile.create_marker(
            " "
        )  # mark the after-intro to add table of contents after the introduction paragraph
    ...
    if add_toc:
        mdFile.new_table_of_contents(
            table_title="Table of Contents", depth=3, marker=intro_marker
        )
